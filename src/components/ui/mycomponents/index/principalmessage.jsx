...
<section className="text-gray-600 dark:text-gray-300 body-font">
  ...
  <div className='  md:w-1/3 w-full drop-shadow-2xl dark:drop-shadow-[0_35px_35px_rgba(0,112,255,0.5)] shadow-blue-400 '> {/* remember images ka sath kaam krte wakt sirf width hi dena hai , height dene ki jrurat nhi( height aspect ratio apne aap adjust kr lega ) and remember width and height hogi vo aspect ratio k parent div mein deni hai*/}
